...
<html>
    ...
    <body>
        ...
        <h1>Cadastro de Paciente</h1>
         <br>
         <div class="quad">
            <form name="forms1" action="/Hostal_Web_2/RecebeCadasPciente" method="post">
               
                <fieldset>
                    <center><legend>Cadastro de Paciente</legend></center>
                    <fieldset>
                            <legend>Dados do paciente</legend>
                        <label for="CPF">CPF</label>
                        <input class="form-control form-control-lg" id="CPF" name="CPF" type="number" min="1" max="99999999999" step="1" value="" placeholder="CPF" required>
                        <br>
                        ...
                        <input class="form-control form-control-lg" type="date" id="dia" name="data" required>
                        </div>
