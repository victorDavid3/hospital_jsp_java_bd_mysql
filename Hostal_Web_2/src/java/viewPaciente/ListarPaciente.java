...
public class ListarPaciente extends javax.swing.JFrame {
    ...
    public void preencherOrdem(){
        ...
        jComboBox_ordem.addItem("Codigo paciente");
        jComboBox_ordem.addItem("Nome paciente");
        jComboBox_ordem.addItem("CPF paciente");
        jComboBox_ordem.addItem("Estado paciente");
        
    }
    
    public void preencherTabela(){
        PacienteDAO  paci = new PacienteDAO();
        //Cria um modelo padrão de tabela
        DefaultTableModel modelo = (DefaultTableModel) jTAlunos.getModel();
        
        //Pecorre dos os valores que vieram do méto listarAlunos()
        for(Paciente a : paci.listarPacientes()){
        //adicionar uma linha na tabela para cada registro que veio na listarAlunos()    
    ...
    private void initComponents() {
        ...
        jTAlunos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Cod Paciente", "Nome", "CPF", "Idade", "Tele 1", "Tele 2", "Estado", "Cidade", "Bairro", "Rau", "Numero endere"
            }
        ) {
